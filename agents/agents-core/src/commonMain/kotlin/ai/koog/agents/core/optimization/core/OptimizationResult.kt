 ...
 *
 * Contains the [artifact] that can be applied to an agent, along with
 * metadata about the optimization process.
 *
 * @property artifact The optimization artifact with tuned instructions and bootstrapped demonstrations.
